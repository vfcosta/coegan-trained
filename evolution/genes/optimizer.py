...
class Optimizer(Gene):
    ...
    def create_phenotype(self, phenotype):
        ...
        if phenotype.optimizer_conf.type == "Adam":
            self.optimizer = optim.Adam(phenotype.parameters(), lr=self.learning_rate, betas=(0, 0.999), weight_decay=phenotype.optimizer_conf.weight_decay)
            ...
            self.optimizer = optim.SGD(phenotype.parameters(), lr=self.learning_rate, weight_decay=phenotype.optimizer_conf.weight_decay)
