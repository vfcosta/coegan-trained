...
class StandaloneAttention(Layer2D):
    ...
    def _create_phenotype(self, input_shape, kernel_size=None):
        self.in_channels = input_shape[1]
        self.out_channels = self.in_channels
        self.kernel_size = kernel_size or config.layer.conv2d.kernel_size
        return AttentionConv(self.in_channels, self.out_channels, self.kernel_size)

    def changed(self):
        return self.in_channels != self.module.in_channels or self.out_channels != self.module.in_channels or \
